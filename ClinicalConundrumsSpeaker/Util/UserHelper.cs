...
namespace ClinicalConundrumsSpeaker.Util
{
    public class UserHelper
    {
        ...
        public static RegistrationStatus GetRegistrationStatus(int UserID)
        {
            RegistrationStatus ps = new RegistrationStatus();


            UserRepository ur = new UserRepository();
            ps = ur.GetRegistrationStatus(UserID);
